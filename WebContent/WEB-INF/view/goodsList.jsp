...
<html lang="ko">
    ...
    <body>
        ...
        <%if (uniqueid != null && uniqueid>=100000){ %>
            <li class="nav-item"><a class="nav-link px-lg-3 py-2 py-lg-4" href="./ProductRegisterView.do">상품 등록</a></li>
        <%} %>
        ...
        <!-- Header-->
        <header class="bg-dark py-5" style="background-image: url('assets/img/home-bg.jpg')">
                    ...
                    <div class="col mb-5">                
                        <div class="card h-100">                        
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="./goodsDetail.jsp">View options</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
