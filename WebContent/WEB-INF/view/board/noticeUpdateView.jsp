...
<body>
	...
	<header class="bg-dark py-5"
		...
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-black">
				<h1 class="display-4 fw-bolder">공지사항 수정하기</h1>
	...
	<section class="py-5">
		...
		<form action="./NoticeUpdate.board" method="post">
		<%
		 int num = Integer.parseInt(request.getParameter("num"));
			 BoardDAO boardDAO = new BoardDAO();
			 BoardDTO edit = boardDAO.NoticeSelect(num);
		...
		%>
			...
			<h3>공지사항 수정하기</h3>
				<!-- 제목 입력 -->
				<input type="hidden" name="num" value="<%= edit.getNum() %>" />
				
				<div class="mb-3">
					<label for="title" class="form-label"></label> <input type="text" class="form-control" id="title" name="title" value="<%= edit.getTitle() %>" required>
				</div>
